        ...
        <div class="wrapper d-flex flex-column min-vh-100 bg-light">
            ...
            <div class="body flex-grow-1 px-3">
                <div class="container-lg">
                  <h2>Dashboard</h2>
                  <p class="lead">
                    A quick data overview of the Master Obat.
                  </p>
                  <div class="row mt-4">
                    <div class="col-sm-6 col-lg-3">
                      <div class="card text-center border-secondary mb-3">
                        ...
                        <div class="card-footer bg-secondary text-white border-secondary"><a href="#" class="text-white" style="text-decoration:none;">View Detailed Report <svg class="icon">
                    ...
                    <div class="col-sm-6 col-lg-3">
                      <div class="card text-center border-primary mb-3">
                        ...
                        <div class="card-footer bg-primary text-white border-primary"><a href="#" class="text-white" style="text-decoration:none;">Visit Master <svg class="icon">
                                  <use xlink:href="<?php echo base_url('assets/@coreui/icons/svg/free.svg#cil-chevron-double-right')?>"></use>
                                </svg></a></div>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                      <div class="card text-center border-danger mb-3">
                        ...
                        <div class="card-footer bg-danger text-white border-danger"><a href="#" class="text-white" style="text-decoration:none;">Resolve Now <svg class="icon">
                              <use xlink:href="<?php echo base_url('assets/@coreui/icons/svg/free.svg#cil-chevron-double-right')?>"></use>
                            </svg></a></div>
                      </div>
                    </div>
