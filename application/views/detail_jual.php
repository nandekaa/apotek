					...
					<table>
						...
						<tr>
							...
							<td><input type="text" name="nabar" value="<?php echo $b['nama_obat'];?>" style="width:380px;margin-right:5px;" class="form-control input-sm" readonly></td>
		                    <td><input type="text" name="satuan" value="<?php echo $b['jenis_obat'];?>" style="width:120px;margin-right:5px;" class="form-control input-sm" readonly></td>
